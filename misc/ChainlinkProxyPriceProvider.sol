...
/// - Owned by the Verge governance system, allowed to add sources for assets, replace them
...
contract ChainlinkProxyPriceProvider is IPriceOracleGetter, Ownable {
    ...
    /// @notice External function called by the Verge governance to set or replace sources of assets
    /// @param _assets The addresses of the assets
    /// @param _sources The address of the source of each asset
    ...
    /// - Callable only by the Verge governance
